                        ...
                        <div className="product-list">
                            {category.plants.map((plant, plantIndex)=>(
                                ...
                                <div className="product-card" key={plantIndex}>
                                    ...
                                    <button className="product-button" onClick={()=>handleAddToCart(plant)} disabled={cartItems.some(item => item.name === plant.name )}>{cartItems.some(item=>item.name === plant.name)?'Added to Cart':'Add to Cart'}</button>
                                </div>
                            ))}
                        </div>
                    </div>
